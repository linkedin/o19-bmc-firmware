...
try:
    ...
    pass
try:
    sys.path.insert(0, testPath + 'powershelf/unittests/')
    import PowershelfUtil
except Exception as e:
    pass
try:
    sys.path.insert(0, testPath + 'yellowsub/unittests/')
    import YellowsubUtil
except Exception as e:
    pass
try:
    sys.path.insert(0, testPath + 'bolt/unittests/')
    import BoltUtil
except Exception as e:
    pass
...
class UnitTestUtil:
    ...
    def importUtil(self, platformType):
        ...
        elif platformType == 'powershelf':
            return PowershelfUtil.PowershelfUtil()
        elif platformType == 'yellowsub':
            return YellowsubUtil.YellowsubUtil()
        elif platformType == 'bolt':
            return BoltUtil.BoltUtil()
        else:
