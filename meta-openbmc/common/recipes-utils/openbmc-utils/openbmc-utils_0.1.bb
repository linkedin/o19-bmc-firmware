...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/flash-upg ${D}${sysconfdir}/flash-upg
    install -m 0755 ${WORKDIR}/clear-boot-sel ${D}${sysconfdir}/clear-boot-sel
    ...
    # the script to mount /mnt/data1, after udev (level 4) is started
    ...
    install -m 755 gen-cert.sh ${D}${sysconfdir}/init.d/gen-cert.sh
    update-rc.d -r ${D} gen-cert.sh start 90 S .
}
