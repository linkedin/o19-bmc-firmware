...
typedef struct
{
  ...
  unsigned char init_from_nv_done;
} lan_config_t;
...
enum
{
  ...
  LAN_PARAM_DEST_TYPE,
  LAN_PARAM_DEST_ADDR,
  LAN_PARAM_VLAN_ID = 20,
  LAN_PARAM_VLAN_PRIO = 21,
...
enum CHANNEL_MEDIUM_TYPE {
  CHANNEL_MEDIUM_RESERVED = 0x0,
  CHANNEL_MEDIUM_IPMB = 0x1,
  CHANNEL_MEDIUM_ICMB_V1_0 = 0x2,
  CHANNEL_MEDIUM_ICMB_V0_9 = 0x3,
  CHANNEL_MEDIUM_LAN = 0x4,
  CHANNEL_MEDIUM_SERIAL = 0x5,
  CHANNEL_MEDIUM_OTHER_LAN = 0x6,
};
