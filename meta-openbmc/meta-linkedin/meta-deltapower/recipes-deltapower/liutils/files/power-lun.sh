...
usage() {
    echo "Usage: $0 on <SW|LUN|ALL-LUNS|ALL> <HW|HWDH|FW|FWDH> <LUN#>" >&2
    echo "    Options:  on          Turning on Switch or LUN"
...
if [ "$#" -eq 2 ]; then
    ...
    case $option3 in
       ...
       HWDH)
          ...
          echo "Turning on LUN$lun eFuses: $eFuse1 and $eFuse2"
       ...
       FWDH)
          ...
          echo "Turning on LUN$lun eFuses: $eFuse1 $eFuse2 $eFuse3, $eFuse4"
          #efuse util goes here
