...
// Delta power shelf specific Platform Abstraction Layer (PAL) Functions
int
pal_get_platform_name(char *name) {
  // Return delta power shelf Specific value
  strcpy(name, DELTAPOWER_PLATFORM_NAME);
  return 0;
}
