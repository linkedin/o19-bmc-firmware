...
#include <facebook/yellowsub_fruid.h>
...
void pal_set_boot_option(uint8_t fru, unsigned char para,unsigned char* pbuff);
void pal_save_boot_option(uint8_t fru, unsigned char* buff);
