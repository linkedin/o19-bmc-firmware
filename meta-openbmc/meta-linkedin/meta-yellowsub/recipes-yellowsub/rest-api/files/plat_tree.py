...
from node_mb import get_node_mb
...
def init_plat_tree():
    ...
    # Add /api/mb to represent main board
    r_mb = tree("mb", data = get_node_mb())
    r_api.addChild(r_mb)
