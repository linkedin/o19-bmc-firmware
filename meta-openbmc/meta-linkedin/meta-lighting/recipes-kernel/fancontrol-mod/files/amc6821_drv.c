...
static const unsigned short normal_i2c[] = {0x18, 0x19, 0x1a, 0x2c, I2C_CLIENT_END};
...
static int init = 0; /*Power-on initialization.*/
...
static int amc6821_init_client(struct i2c_client *client)
{
    ...
    if(gpio_get_value(76))
        return 0;

    // Set fan speed to 80%
    uint8_t config_dcy = 0xCD;
    if (i2c_smbus_write_byte_data(client, AMC6821_REG_DCY,
        config_dcy)) {
    dev_err(&client->dev,
    "Configuration register write error, aborting.\n");
    return err;
    ...
    // Set PWM enable, Tach mode & Tach Enable
    uint8_t conf_reg_2 = i2c_smbus_read_byte_data(client, AMC6821_REG_CONF2);
    conf_reg_2 |= AMC6821_CONF2_PWM_EN;
    conf_reg_2 |= AMC6821_CONF2_TACH_MODE;
    conf_reg_2 |= AMC6821_CONF2_TACH_EN;
    ...
    // Set mode to software and start bit
    uint8_t conf_reg_1 = i2c_smbus_read_byte_data(client, AMC6821_REG_CONF1);
    conf_reg_1 &= ~AMC6821_CONF1_FDRC0;
    conf_reg_1 &= ~AMC6821_CONF1_FDRC1;
    conf_reg_1 |= AMC6821_CONF1_PWMINV;
    conf_reg_1 |= AMC6821_CONF1_START;
