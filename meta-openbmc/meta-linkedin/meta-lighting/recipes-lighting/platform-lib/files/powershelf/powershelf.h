 ...
 */
#define   I2C_MASTER_EFUSE_BUS_1        1
#define   I2C_MASTER_EFUSE_BUS_2        2
#define   I2C_MASTER_SELETOR_ADDR_1     0x79
#define   I2C_MASTER_SELETOR_ADDR_2     0x7a
...
#define    MAX_TEMP_SENSOR_NUM     12
#define    MAX_TEMP_EFUSE_NUM      48
#define    TEMP_MUX_ADDR           0x7e
#define    MAX_EFUSE_TEMP          120
#define    WARN_EFUSE_TEMP         80
...
typedef struct fan_info {
    int      i2c_bus;
    int      i2c_addr;
    fan_status_t fan_status[MAX_FAN_NUM];
...
int   fan_get_status(fan_info_t *fan_info, int fan_num);
